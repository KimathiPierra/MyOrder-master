package com.example.pierra.myorder.Service;
...
import com.example.pierra.myorder.OrderStatus;
import com.example.pierra.myorder.R;
...
public class ListenOrder extends Service implements ChildEventListener {
    ...
    private void showNotification(String key, Request request) {
        ...
        builder.setAutoCancel(true)
                ...
                .setTicker("Pierra")
                .setContentInfo("Your order status has been updated")
